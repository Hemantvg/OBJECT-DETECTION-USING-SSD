...
if live_video:
    ...
    vs = cv2.VideoCapture('D:/Object Detection using SSD/Object Detection using SSD/moving vehicle video_3.mp4')
...
while ret:
    ...
    if ret:
        ...
        blob = cv2.dnn.blobFromImage(frame, 0.007843, (1000, 600), 127.5)
        net.setInput(blob)
